...
/**
 * 
 * @author Virgile Api de gestion du royaume des princesses
 */
...
public class PrincesseController {
	...
	/**
	 * Retourne la princesse en fonction de l'id passé en paramètre, 404 not found
	 * en cas d'echec
	 * 
	...
	/**
	 * Ajoute à la liste les paramètres reçu afin de créer une princesse et
	 * l'ajouter à la liste existante
	 * 
	...
	public List<Princesse> ajoutPrincesse(@RequestParam(value = "name") String name,
			@RequestParam(value = "univers") String univers, @RequestParam(value = "description") String description,
			@RequestParam(defaultValue = "https://radiodisneyclub.fr/wp-content/uploads/2018/05/princesse-disney.jpg", value = "url") String url) {
		if (name != "" && univers != "" && description != "") {
